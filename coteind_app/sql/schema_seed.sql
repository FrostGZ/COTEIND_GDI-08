CREATE SCHEMA IF NOT EXISTS `coteind` DEFAULT CHARACTER SET utf8 ;
USE `coteind` ;

CREATE TABLE IF NOT EXISTS `coteind`.`Empresa` (
...
CREATE TABLE IF NOT EXISTS `coteind`.`Direccion_Empresa` (
  ...
  CONSTRAINT `fk_Direccion_Empresa_Empresa`
    ...
    REFERENCES `coteind`.`Empresa` (`RUC`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

CREATE TABLE IF NOT EXISTS `coteind`.`Telefono_Empresa` (
  `RUC_Empresa` VARCHAR(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `coteind`.`Correo_Empresa` (
  `RUC_Empresa` VARCHAR(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `coteind`.`Empleado` (
  `Codigo` CHAR(5) NOT NULL,
  `Nombre` TEXT(50) NOT NULL,
  PRIMARY KEY (`Codigo`))
ENGINE = InnoDB;

CREATE TABLE IF NOT EXISTS `coteind`.`Proveedor` (
  `RUC` VARCHAR(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `coteind`.`Orden_Compra` (
  ...
  CONSTRAINT `fk_Orden_Compra_Empleado1`
    ...
    REFERENCES `coteind`.`Empleado` (`Codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Orden_Compra_Proveedor1`
    FOREIGN KEY (`RUC_Proveedor`)
    REFERENCES `coteind`.`Proveedor` (`RUC`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

CREATE TABLE IF NOT EXISTS `coteind`.`Contacto_Empleado` (
  `Codigo_Empleado` VARCHAR(5) NOT NULL,
  `Telefono` VARCHAR(15) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `coteind`.`Email_Proveedor` (
  `RUC_Proveedor` VARCHAR(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `coteind`.`Telefono_Proveedor` (
  `RUC_Proveedor` VARCHAR(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `coteind`.`Repuesto` (
...
CREATE TABLE IF NOT EXISTS `coteind`.`Proforma` (
  ...
  CONSTRAINT `fk_Proforma_Repuesto1`
    ...
    REFERENCES `coteind`.`Repuesto` (`Nro_Parte`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
